...
public class Transfer {
    public static List<Builder> StringsToBuilders(List<String> lines) { //перевод строк в объекты
    ...
    public static List<String> BuilderToString(List<Builder> builders) { //перевод объектов в строки
